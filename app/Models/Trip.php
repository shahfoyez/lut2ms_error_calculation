...
class Trip extends Model
{
    ...
    public function tripDistance()
    {
        return $this->hasOne(VehicleTripDistance::class, 'trip_id');
    }
    public function trip2error()
    {
        return $this->hasMany(Error2Distance::class, 'trip_id');
    }
