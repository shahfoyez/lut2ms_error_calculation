            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        @php
                            $formAction = url('/trip/vehicleTrips/'.$vehicle->id.'/filter');
                            $refreshAction = url('/trip/vehicleTrips/'.$vehicle->id);
                        @endphp
                            ...
                            <tbody>
                                @if($trips && $trips->count()>0)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/user/profile/'.$trip->employee->id) }}" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $trip->employee->name }}</a>
                                        </td>
                                        <td>
