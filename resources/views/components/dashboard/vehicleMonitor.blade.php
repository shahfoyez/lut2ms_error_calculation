...
<div class="row g-5 g-xl-8">
    <div class="col-xl-4">
        ...
        <a href="{{ url('/requisition/vehicles/filter?status=available') }}" class="card bg-success hoverable card-xl-stretch mb-xl-8">
            <!--begin::Body-->
            <div class="card-body">
    ...
    <div class="col-xl-4">
        <!--begin::Statistics Widget 5-->
        <a href="{{ url('/requisition/vehicles/filter?status=trip') }}" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
            <!--begin::Body-->
            <div class="card-body">
    ...
    <div class="col-xl-4">
        <!--begin::Statistics Widget 5-->
        <a href="{{ url('/vehicle/vehicles/filter?status=maintenance') }}" class="card bg-danger hoverable card-xl-stretch mb-5 mb-xl-8">
            <!--begin::Body-->
            <div class="card-body">
