...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            @include('components.dashboard.drivers_map')
            <!--begin::fuel-->
            <!--begin::Row-->
                        ...
                        <div class="card-header border-0 bg-warning py-5">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ url('fuel/fuelVehicles') }}" class="menu-link px-3">Vehicles</a>
                                    </div>
                                    <!--end::Menu item-->

                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ url('fuel/fuelRecords') }}" class="menu-link px-3">Trip History</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu 3-->
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
                                ...
                                <!--end::Title-->
                                <!--begin::Lable-->
                                <span class="fw-bolder text-danger py-1">৳{{ $maintenanceData['totalCost'] }}</span>
                                <!--end::Lable-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
                                ...
                                <!--end::Title-->
                                <!--begin::Lable-->
                                <span class="fw-bolder text-danger py-1">৳{{ $maintenanceData['avgCost'] }}</span>
                                <!--end::Lable-->
                            </div>
                            <!--end::Item-->
                            <?php
                        ...
                        <div class="card-header border-0 bg-danger py-5">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ url('/maintenance/maintenanceVehicles') }}" class="menu-link px-3">Vehicles</a>
                                    </div>
                                    <!--end::Menu item-->

                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ url('/maintenance/maintenanceRecords') }}" class="menu-link px-3">Records</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu 3-->
