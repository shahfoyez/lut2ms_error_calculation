            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        @php
                            $formAction = url('/fuel/vehicleFuels/'.$vehicle->id.'/filter');
                            $refreshAction = url('/fuel/vehicleFuels/'.$vehicle->id);
                        @endphp
                                ...
                                @if($fuels && $fuels->count()>0)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endphp
                                            <p class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6 {{  $typeClass }}">{{ $type }}</p>
                                            {{-- <span class="text-muted fw-bold text-muted d-block fs-7">Rejected</span> --}}
                                        </td>
                                        <td>
                                            <p class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $fuel->quantity }} Litter</p>
                                        ...
                                        <td>
                                            ...
                                            @endphp
                                            <p class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6 {{  $costClass }}"> TK: {{ $cost }}  </p>
                                            {{-- <span class="text-muted fw-bold text-muted d-block fs-7">Rejected</span> --}}
                                        </td>
                                        <td>
                                            <p class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $fuel->date->format('d M Y') }}</p>
                                        ...
                                        <td class="text-end">
                                            <a href="{{ url('/fuel/editFuelRecord/'.$fuel->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            ...
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#delete_Modal" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm cd_modal" data-item="{{ url('/fuel/fuelDelete/'.$fuel->id) }}" >
