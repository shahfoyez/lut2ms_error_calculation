                ...
                @endif
                    <div class="card-body py-3">
                        ...
                        <div class="table-responsive">
                            <!--begin::Table-->
                            <table id="" class="table table-striped gy-5 gs-7 border rounded">
                                <!--begin::Table head-->
                                <thead>
                                ...
                                <!--begin::Table body-->
                                <tbody>
                                @if($tripWithDistance && $tripWithDistance->count()>0)
                                    @foreach($tripWithDistance as $tripDistance)
                                        @foreach($tripDistance->trip2error as $error)
                                            <tr>
                                            <td>
                            ...
                            <div class="card-header border-0 bg-danger py-5">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="/maintenance/maintenanceVehicles" class="menu-link px-3">Vehicles</a>
                                        </div>
                                        <!--end::Menu item-->
