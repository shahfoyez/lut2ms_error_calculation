            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ url('/vehicle/vehicleAdd') }}" class="btn btn-sm btn-light-primary me-2 border border-secondary py-4">
                        ...
                        New Vehicle</a>
                        <?php
                            $formAction = url('/vehicle/vehicles/filter');
                            $refreshAction = url('/vehicle/vehicles');
                        ?>
                            ...
                            <tbody>
                                @if($lists && $lists->count()>0)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($list->gpsDevice)
                                                <a href="{{ url('/vehicle/deviceEdit/'.$list->gpsDevice->id) }}" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $list->gpsDevice->code_name }}</a>
                                            @else
                                        ...
                                        <td class="text-end">
                                            @if($list->status != 'trip')
                                                <a href="{{ url('/vehicle/vehicleEdit/'.$list->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                ...
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#delete_Modal" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm cd_modal" data-item="{{ url('/vehicle/vehicleDelete/'.$list->id) }}" >
