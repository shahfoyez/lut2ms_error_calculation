                ...
                <div class="flex-column flex-lg-row-auto w-100 w-lg-300px w-xl-400px mb-10 mb-lg-0">
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header pt-7" id="kt_chat_contacts_header">
                            <!--begin::Form-->
                            <form class="w-100 position-relative" autocomplete="on" action="{{ url('/chat/chatSearch') }}" method="get">
                                {{-- @csrf --}}
                                <!--begin::Icon-->
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-2">
                                    ...
                                    <a href="{{ url('/chat/chats') }}" class="foy-reload btn btn-icon btn-bg-light btn-active-color-primary btn-sm px-4">
    ...
    <script>
        $(document).on("click", ".foy-chat", function () {
            ...
            <div class="card-footer pt-4" id="kt_chat_messenger_footer">
                <form action="{{ url('/chat/reply') }}" class="form" method="post" id="">
                    @csrf
