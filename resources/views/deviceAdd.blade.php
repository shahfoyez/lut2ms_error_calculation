                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12 pe-lg-10">
                                <!--begin::Form-->
                                <form action="{{ url('/vehicle/deviceAdd') }}" class="form" method="post" id="">
                                    @csrf
                                    <h1 class="fw-bolder text-dark mb-9">Add GPS Device</h1>
                                    <!--begin::Input group-->
                                    <div class="row mb-6">
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" name="code_name" class="form-control mb-3 mb-lg-0" placeholder="Code Name" value="{{ old('code_name') }}" />
                                            @error('code_name')
