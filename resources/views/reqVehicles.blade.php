            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <?php
                            $formAction = url('/requisition/vehicles/filter');
                            $refreshAction = url('/requisition/vehicles');
                        ?>
                                ...
                                @if($lists && $lists->count()>0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end d-flex justify-content-end">
                                            @if($list->status == 'available')
                                                <a href="{{ url('/requisition/send/'.$list->id) }}" class="btn btn-primary p-2 me-2">
                                                    Send
                                                </a>
                                            @elseif($list->status == 'trip')
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu foy-req-action" aria-labelledby="dropdownMenuButton1">
                                                        <li>
                                                            <a href="{{ url('/requisition/edit/'.$list->activeTrip->id) }}" class="dropdown-item pt-2 pb-2" href="#">Edit</a></li>
                                                        </li>
                                                        <li>
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#reach_Modal" class="dropdown-item pt-2 pb-2 reach_modal" data-item="{{ url('/requisition/reach/'.$list->id) }}">Reach</a>
                                                        </li>
                                                        <li>
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#cancel_Modal" class="dropdown-item pt-2 pb-2 cancel_modal" data-item="{{ url('/requisition/cancel/'.$list->id) }}">Cancel</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            @endif
                                            <a href="{{ url('/trip/vehicleTrips/'.$list->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
