            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ url('/employee/designationAdd') }}" class="btn btn-sm btn-light-primary border border-secondary py-4">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            {{-- <a href="/employee/designationDelete/{{ $designation->id }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm"> --}}
                                                <a href="{{ url('/employee/designationDelete/'.$designation->id) }}" data-bs-toggle="modal" data-bs-target="#delete_Modal" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm cd_modal" id="" data-item="{{ url('/employee/designationDelete/'.$designation->id) }}" >
