                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12 pe-lg-10">
                                <!--begin::Form-->
                                <form action="{{ url('/notice/noticeUpdate/'.$notice->id) }}" class="form mb-15" method="post" id="" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <select class="form-select" name="status" data-control="select2" data-placeholder="Status" data-hide-search="true">2
                                                <?php
                                                    $status = old('status') ?? $notice->status;
                                                ?>
                                                <option value="0" {{ $status == '0' ? 'selected' : '' }}>Regular</option>
                                                <option value="1" {{ $status == '1' ? 'selected' : '' }}>Emergency</option>
                                            </select>
                                            @error('status')
