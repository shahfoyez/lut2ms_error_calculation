            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <?php
                        $formAction = url('/meter/meterVehicles/filter');
                        $refreshAction = url('/meter/meterVehicles');
                        ?>
                        ...
                        <table id="kt_datatable_example_5" class="table table-striped gy-5 gs-7 border rounded">
                            ...
                            <thead>
                                <tr class="fw-bolder fs-6 text-gray-800 px-7">
                                    ...
                                    <th class="min-w-125px">Total Run</th>
                            ...
                            <tbody>
                                @if($vehicles && $vehicles->count()>0)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                if ($vehicle->meter_entries_count){
                                                    $totalEntries = $vehicle->meter_entries_count;
                                        ...
                                        <td>
                                            @php
                                                if ($vehicle->meter_entries_max_date){
                                                    $maxDate = $vehicle->meter_entries_max_date->format('d M Y');
                                                    $maxTime = $vehicle->meter_entries_max_date->format('h:i A');
                                                    $maxClass = "";
                                                }else{
                                                    $maxDate = "No Data";
                                                    $maxTime = "";
                                        ...
                                        <td class="text-end">
                                            <a href="{{ url('/meter/meterEntryAdd/'.$vehicle->id) }}" class=" btn btn-primary p-2">
                                                +Entry
                                            </a>
                                            {{-- <a href="/requisition/send/{{ $vehicle->id }}" class=" btn btn-primary p-2">
                                                Records
                                            </a> --}}
                                            <a href="{{ url('/meter/vehicleMeterEntries/'.$vehicle->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
