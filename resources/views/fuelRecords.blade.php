            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Fuel Records
                    ...
                    <div class="card-toolbar">
                        <?php
                            $formAction = url('/fuel/fuelRecords/filter');
                            $refreshAction = url('/fuel/fuelRecords');
                        ?>
                            ...
                            <tbody>
                                @if($fuels && $fuels->count()>0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="{{ url('/fuel/edit/'.$fuel->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
