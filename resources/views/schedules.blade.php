            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ url('/schedule/scheduleAdd') }}" class="btn btn-sm btn-light-primary border border-secondary py-4">
                            ...
                            <tbody>
                                @if($schedules && $schedules->count() > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="{{ url('/schedule/scheduleEdit/'.$schedule->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            ...
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#delete_Modal" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm cd_modal" data-item="{{ url('/schedule/delete/'.$schedule->id) }}" >
